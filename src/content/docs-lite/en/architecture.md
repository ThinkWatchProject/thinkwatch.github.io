...
- **`src-tauri/`** is the Tauri 2 shell. It supervises ThinkWatch Core and renders the menu bar. On macOS, the supervisor integrates with launchd.
- **`src/`** is the frontend, written in React 19 and Tailwind 4.

## Lite and Core

The gateway is implemented in [ThinkWatch Core](/docs/core). This repository contains no routing, forwarding, or accounting logic. Lite communicates with Core over a unix socket.
