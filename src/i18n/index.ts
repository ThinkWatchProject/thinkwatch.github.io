...
const dict = {
  en: {
    ...
    problem: {
      ...
      sub: "As AI agents spread across engineering teams, organizations face a growing governance challenge.",
      pains: [
        { icon: "key", title: "Keys scattered everywhere", body: "Hardcoded in .env files, shared in chat, rarely rotated." },
        { icon: "eye", title: "Zero visibility", body: "Who used which model, how many tokens, at what cost?" },
        { icon: "shield", title: "No access control", body: "Every developer has direct access to every model and every MCP tool." },
        { icon: "audit", title: "Compliance gaps", body: "No audit trail for AI-assisted code generation or data access." },
        { icon: "cost", title: "Cost surprises", body: "Monthly AI bills that nobody can explain or attribute." },
      ],
    ...
    quickstart: {
      ...
      footer: "A drop-in replacement: swap the base URL and use a virtual ",
      footerSuffix: " key.",
      steps: [
        ...
        { title: "Finish the setup wizard", body: "Create the super_admin account, configure the site, and optionally add your first provider and API key." },
      ],
    },
    ...
    footer: {
      tagline: "One gateway between your AI clients and the models they call.",
      product: "Products",
      resources: "Resources",
    ...
    notFound: {
      ...
      sub: "The link may be out of date, or the page may have moved. One of these should get you back on track.",
      home: "Home",
      thinkwatch: "ThinkWatch",
  ...
  "zh-CN": {
    ...
    problem: {
      ...
      title: "AI 无处不在，治理却",
      titleHighlight: "无人问津",
      sub: "随着 AI Agent 在工程团队中普及，组织面临越来越大的治理难题。",
      pains: [
        { icon: "key", title: "密钥四散", body: "硬编码在 .env 里、在聊天工具里互传，很少轮换。" },
        { icon: "eye", title: "毫无可见性", body: "谁用了哪个模型、消耗了多少 token、花了多少钱？" },
        { icon: "shield", title: "没有访问控制", body: "每位开发者都能直连任意模型和任意 MCP 工具。" },
        { icon: "audit", title: "合规盲区", body: "AI 辅助生成代码和访问数据，都没有审计记录。" },
        { icon: "cost", title: "成本说不清", body: "每月的 AI 账单没人能解释，也没法归到具体的人或团队。" },
      ],
    ...
    quickstart: {
      ...
      deployLink: "部署指南",
      pointAt: "然后把客户端指向网关",
      footer: "可直接替换：只需换掉 base URL，并使用虚拟 ",
      footerSuffix: " 密钥。",
      steps: [
        { title: "启动基础设施", body: "通过 Docker Compose 拉起 PostgreSQL、Redis、ClickHouse 以及其他开发依赖服务。" },
    ...
    notFound: {
      ...
      headline: "这个地址下什么也没有。",
      sub: "链接可能已经过期，或者页面已经移动。可以从下面这些地方继续。",
      home: "首页",
      thinkwatch: "ThinkWatch",
      lite: "ThinkWatch Lite",
      core: "ThinkWatch Core",
